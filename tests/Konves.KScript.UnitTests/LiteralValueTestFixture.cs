...
namespace Konves.KScript.UnitTests
{
	...
	public class LiteralValueTestFixture
	{
		...
		{
			DoEqualsTest(null, null, true);

			DoEqualsTest("asdf", "asdf", true);
			DoEqualsTest("asdf", "ASDF", false);

			DoEqualsTest(DateTime.Parse("2015-1-1"), "2015-1-1", false);
			DoEqualsTest("2015-1-1", DateTime.Parse("2015-1-1"), false);
			DoEqualsTest(DateTime.Parse("2015-1-1"), DateTime.Parse("2015-1-1"), true);
			DoEqualsTest("2015-1-1", "2015-1-1T00:00:00", false);

			DoEqualsTest((decimal)5, (decimal)5, true);
			DoEqualsTest("5", (decimal)5, false);
			DoEqualsTest((decimal)5, "5", false);
			DoEqualsTest((decimal)6, (decimal)5, false);

			DoEqualsTest(true, true, true);
			DoEqualsTest(true, false, false);
			DoEqualsTest("true", true, false);
			DoEqualsTest(true, "true", false);
		}
